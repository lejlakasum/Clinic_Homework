    ...
    public partial class OsobljePanel : Form
    {
        ...
        private void comboBox_PretragaPo_SelectedIndexChanged(object sender, EventArgs e)
        {
            if(comboBox_PretragaPo.SelectedIndex==0)
            {
                ...
                Parallel.ForEach(Glavna.klinika17280_1.KlinickeOrdinacije, o =>
                {

                    this.Invoke(new Action(() => comboBox_OdabirPac_Ord.Items.Add(o.ImeOrdinacije)));
                });
            }
            else
            {
        ...
        private void button_DajCekanje_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (comboBox_PretragaPo.SelectedIndex == 1)
                {
                    ...
                    Parallel.For(0, listaOdabranihPregleda.Count, i =>
                   {

                       int brojIspred = listaOdabranihPregleda[i].OrdinacijaUKojojSeObavlja.BrojPacijenataNaCekanju - 1;
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText(Environment.NewLine)));
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText(i + 1 + ".")));
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText(Environment.NewLine)));
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText(listaOdabranihPregleda[i].ImePregleda)));
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText(Environment.NewLine)));
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText("Ordinacija: " + listaOdabranihPregleda[i].OrdinacijaUKojojSeObavlja.ImeOrdinacije)));
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText(Environment.NewLine)));
                       this.Invoke(new Action(() => textBox_CekanjePacijent.AppendText("Broj osoba ispred: " + brojIspred)));
                   });
                }
                else
                {
        ...
        private void button_TPL_Click(object sender, EventArgs e)
        {
            if (Glavna.klinika17280_1.RegistrovaneOsobe.FindIndex(o => o.MaticniBroj == textBox1.Text) != -1)
            {
                listBox_TPLpac.Items.Clear();
                listBox_TPLKart.Items.Clear();
                Pacijent pacijent17280 = Glavna.klinika17280_1.RegistrovaneOsobe.Find(pac => pac.MaticniBroj == textBox1.Text) as Pacijent;
                
                Parallel.Invoke(() =>
                {
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Ime: " + pacijent17280.Ime)));
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Prezime: " + pacijent17280.Prezime)));
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Datum rodjenja: " + pacijent17280.DatumRodjenja.ToShortDateString())));
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Maticni broj: " + pacijent17280.Ime)));
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Adresa: " + pacijent17280.Ime)));
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Spol: " + pacijent17280.Spol)));
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Bracno stanje: " + pacijent17280.BracnoStanje)));
                    this.Invoke(new Action(() => listBox_TPLpac.Items.Add("Email: " + pacijent17280.Email)));
                },
                () =>
                {
                    Parallel.ForEach(pacijent17280.KartonPacijenta.ListaPregleda, p =>
                    {
                        this.Invoke(new Action(() => listBox_TPLKart.Items.Add(p.DatumPregleda)));
                        this.Invoke(new Action(() => listBox_TPLKart.Items.Add(p.PregledKojiSeObavlja)));
                        this.Invoke(new Action(() => listBox_TPLKart.Items.Add(p.PregledObavio.Ime +" " + p.PregledObavio.Prezime)));
                        this.Invoke(new Action(() => listBox_TPLKart.Items.Add(p.RezultatPregleda)));
                        this.Invoke(new Action(() => listBox_TPLKart.Items.Add("\n")));
                    });
                });
            ...
            {
                toolStripStatusLabelOsoblje.ForeColor = Color.Red;
                toolStripStatusLabelOsoblje.Text = "Nepostojeći matični broj";
            }
        }
    }
}
