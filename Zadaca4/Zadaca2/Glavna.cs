...
namespace Zadaca2
{
    public class Glavna
    {
        ...
        public static async void DodajIzuzetak(Izuzetak ex)
        {
            ...
            await Task.Run(()=> pisac.WriteLine("{0},{1},{2},{3}", ex.Tip.ToString(), ex.VrijemeNastanka.ToString(), ex.Izazvao, ex.TekstIzuzetka));
            pisac.Flush();
            f.Close();
        }
        public static void registracija()
        {
            ...
            Karton k = new Karton();
            Anamneza a = new Anamneza("asd", "asd", "asd", "asd");
            Terapija t = new Terapija("Nek terapija", 5);
            PacijentovPregled pregled = new PacijentovPregled(Glavna.klinika17280_1.DostupniPregledi[5], DateTime.Today,
                Glavna.klinika17280_1.RegistrovaneOsobe[3] as Doktor, "rezz", "misljenje", t);
            k.AnamnezaPacijenta = a;
            k.ListaPregleda.Add(pregled);
            p.KartonPacijenta = k;
        }
